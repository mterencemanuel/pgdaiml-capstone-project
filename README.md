...
Project Title: Anomaly Detection using Machine Learning Algorithms
...
All have been saved in oneupynb called Capstone_Project_All
EDA.ipynb
...
│
├── data/
│   ├── raw/               ← Original data (or link to source)
